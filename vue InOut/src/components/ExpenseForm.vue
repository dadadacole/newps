<template>
    <div class="form-container">
        <div class="buttons">
            <button :class="{ active: mode === 'income' }" @click="mode = 'income'">수입</button>
            <button :class="{ active: mode === 'expense' }" @click="mode = 'expense'">지출</button>
        </div>
        <div class="categories">
            <button :class="{ active: category === 'salary' }" @click="category = 'salary'">월급</button>
            <button :class="{ active: category === 'allowance' }" @click="category = 'allowance'">용돈</button>
        ...
        <div>
            ...
            <input type="text" id="amount" v-model="formattedAmount" @input="formatAmount" />
        </div>
        <div>
        ...
        <div v-if="imageUrl">
            <img :src="imageUrl" alt="첨부 이미지" style="max-width: 100%; margin-top: 10px" />
        </div>
    </div>
</template>
