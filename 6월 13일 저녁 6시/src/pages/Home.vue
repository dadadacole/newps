...
export default {
    ...
    data() {
        return {
            ...
            expenseCategories: ['식비', '도서', '통신', '문화생활', '여행'],
    ...
    methods: {
        ...
        goToInOut() {
            ...
            }); // Ensure the path matches the router setup
        },
    ...
    async mounted() {
        ...
        this.$on('delete-transaction', this.deleteTransaction);
        this.$on('update-transactions', this.updateTransaction);
    },
};
</script>
